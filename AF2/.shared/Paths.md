...
Basic instructions about Ivy Framework:
...
Breaking changes in Ivy-Framework are documented as "refactor" prompts:
...
Shared code between client and server, including message definitions.
...
Agent workflow definitions are defined in:
