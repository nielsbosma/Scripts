...
## Known Issues
- **Ivy.Tendril.slnx build failures**: Previously failed on `plan-01612-Ivy-Tendril-fresh` due to API incompatibilities. Resolved as of run 00058 — builds clean with `-warnaserror`.
